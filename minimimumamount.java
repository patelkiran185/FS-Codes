...
// import java.util.*;
// class Sol{
//     private static int getminimumamount(int[] amounts,int n,int c){
//         int tsum=0;
       
//         int maxRedu=0;
//         for(int i=0;i<n;i++){
//             tsum+=amounts[i];
//             maxRedu=Math.max(maxRedu,Math.min(amounts[i],c));
//         }
//         int ans=tsum-maxRedu;
//         return ans+1;
//     }
...
//         for(int i=0;i<n;i++){
//             amounts[i]=Integer.parseInt(parts[i]);
//         }
//         System.out.print(getminimumamount(amounts,n,c));
//     }
// }